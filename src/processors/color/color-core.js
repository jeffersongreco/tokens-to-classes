...
/**
 * Converts a nested JSON object into CSS variables.
 * The variables are created with a specific naming convention based on the typePrefix provided.
 *
 * @param {object} json - The nested JSON object to be converted to CSS variables.
...
export default colorCoreToVariables;
